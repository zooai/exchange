...
vi.mock('@l.x/ui/src/assets/logos/png/lux-logo.png', () => createAssetModuleMock('png'))
...
vi.mock('@l.x/ui/src/assets/logos/png/lux-logo-large.png', () => createAssetModuleMock('png'))
