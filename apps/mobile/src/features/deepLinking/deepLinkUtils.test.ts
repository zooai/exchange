...
describe('getDeepLinkAction', () => {
  it.each`
    url                                                                                                  | expected
    ${'https://app.lux.network/app?screen=transaction&fiatOnRamp=true&userAddress=0x123'}                | ${DeepLinkAction.LuxWebLink}
    ...
    ${'https://support.lux.network/hc/en-us/articles/test-article-123'}                                  | ${DeepLinkAction.LuxExternalBrowserLink}
    ${'https://blog.lux.network/article'}                                                                | ${DeepLinkAction.LuxExternalBrowserLink}
    ${'https://dex.lux.network/'}                                                                   | ${DeepLinkAction.LuxExternalBrowserLink}
